...
final class TemplateDesignRegistry {
    public static function definitions(): array {
        ...
        return [
            ...
            "article_numbered_list" => [
                "source_key" => "article_numbered_list_color_source",
                "custom_key" => "article_numbered_list_accent_color",
                "template_key" => "article_numbered_list_style",
                "default_template" => "nlist01",
                "fallback" => "#00ff41",
                "palettes" => [
                    "none" => [ "accent" => "#9ca3af" ],
                    "nlist01" => [ "accent" => "#00ff41" ],
                    "nlist02" => [ "accent" => $blue ],
                    "nlist03" => [ "accent" => $red ],
                    "nlist04" => [ "accent" => "#111827" ],
                    "nlist05" => [ "accent" => "#a16207" ],
                ],
                "variables" => [
                    "--smpi-numbered-list-accent" => "color",
                    "--smpi-numbered-list-accent-soft" => "rgba:0.10",
                    "--smpi-numbered-list-accent-ink" => "contrast",
                ],
            ],
            "article_drop_cap" => [
    ...
    public static function typography_definitions(): array {
        return [
            ...
            "article_numbered_list" => [
                "title" => "Numbered list typography",
                "font_family" => [ "key" => "article_numbered_list_font_family", "label" => "List font" ],
                "font_weight" => [ "key" => "article_numbered_list_font_weight", "label" => "List weight" ],
                "font_color" => [ "key" => "article_numbered_list_text_color", "label" => "List text color" ],
                "font_size" => [ "key" => "article_numbered_list_font_size", "label" => "List text size", "min" => 8, "max" => 64, "suffix" => "px" ],
            ],
            "article_drop_cap" => [
    ...
    public static function typography_variable_definitions(): array {
        return [
            ...
            "article_numbered_list" => [ "font_color" => [ "--smpi-numbered-list-text", "article_numbered_list_text_color", "color", "#1f2937" ], "font_size" => [ "--smpi-numbered-list-size", "article_numbered_list_font_size", "size", 16, 8, 64 ] ],
    ...
    public static function font_family_css_variables(): array {
        return [
            ...
            "article_numbered_list_font_family" => "--smpi-numbered-list-font",
    ...
    public static function font_weight_css_variables(): array {
        return [
            ...
            "article_numbered_list_font_weight" => "--smpi-numbered-list-weight",
    ...
    public static function preview_typography_selectors(): array {
        return [
            ...
            "article_numbered_list" => [
                "font_family" => ".smpi-numbered-list,.smpi-numbered-list-title,.smpi-numbered-list-text",
                "font_weight" => ".smpi-numbered-list,.smpi-numbered-list-title,.smpi-numbered-list-text",
                "font_color" => ".smpi-numbered-list-title,.smpi-numbered-list-text",
                "font_size" => ".smpi-numbered-list-title,.smpi-numbered-list-text",
            ],
            "article_drop_cap" => [
