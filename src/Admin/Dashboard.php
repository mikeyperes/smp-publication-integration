...
final class Dashboard {
    ...
    private function author_icon_preview_html( array $settings, string $style = "" ): string {
        ...
        return "<span class=\"" . esc_attr( $class ) . "\" style=\"--smpi-muckrack-color:" . esc_attr( $color ) . ";color:" . esc_attr( $color ) . "\" aria-label=\"Verified by MuckRack editorial team\">" . $this->muckrack_icon_svg_html( $style ) . "</span>";
    }
