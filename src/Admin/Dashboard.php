...
[smp_post_authors context=\"card\" format=\"lines\"]", $this->multi_authors_report_html(), $this->activity_log_html(), $multi_author_controls );
    ...
    private function article_heading_preview_html( string $style ): string {
        ...
        $class = "none" === $style ? "smpi-ah-preview smpi-ah-preview-none" : "smpi-ah-preview smpi-ah-preview-" . $style;
        return "<div class=\"" . esc_attr( $class ) . "\"><h2>Where the method began</h2><p>This section walks through how the idea first took shape and why it connected with early readers.</p><h3>What changed next</h3><p>The same selected treatment applies to article H3 subheadings inside post content.</p></div>";
    }
