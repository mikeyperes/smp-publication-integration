...
[smp_post_authors context=\"card\" format=\"lines\"]", $this->multi_authors_report_html(), $this->activity_log_html(), $multi_author_controls );
    ...
    private function feature_card( string $title, string $toggle_key, string $acf, string $description, string $code, string $test_report, string $activity_log, string $extra_controls = "", bool $collapsible = false ): void {
        ...
        if ( $collapsible ) {
            echo CoreUi::collapsible(
                [
                    ...
                    "body_html" => $html,
                    "open" => false,
                    "meta_html" => $toggle_key && Settings::bool( $toggle_key )
    ...
    private function feature_card_from_snippet( string $snippet_id, string $extra_report_html = "" ): void {
        ...
        $this->feature_card(
            ...
            "",
            "elementor_css_cache_busting" === $snippet_id,
        );
    }
