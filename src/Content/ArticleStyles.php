...
final class ArticleStyles {
    ...
    public function print_styles(): void {
        ...
        echo "<style id=smpi-article-style-controls>" . self::frontend_vars_css() . self::breadcrumbs_css() . self::toc_css() . self::article_heading_css( $heading ) . self::article_drop_cap_css() . self::post_acf_css() . self::inline_photo_css( $photo ) . self::featured_image_caption_css( $featured ) . "</style>";
    }
    ...
    private static function frontend_vars_css(): string {
        ...
        $css .= ".smpi-breadcrumbs{--smpi-bc-accent:" . $bc["accent"] . ";--smpi-bc-tint:" . $bc["tint"] . ";--smpi-bc-background:" . $bc["background"] . ";--smpi-bc-font-size:" . $bc["size"] . "}";
        ...
        if ( Settings::bool( "article_drop_cap_enabled" ) ) {
            ...
            $css .= "body.single-post{--smpi-dropcap-color:" . $d["color"] . ";--smpi-dropcap-size:" . $d["size"] . "}";
        }
    ...
    public static function article_heading_css( string $style ): string {
        ...
        $scope = "body.single-post :where(.entry-content,.post-content,.single-post-content,.wp-block-post-content,.elementor-widget-theme-post-content .elementor-widget-container,.elementor-widget-post-content .elementor-widget-container)";
        return self::article_heading_rules( $style, $scope, $scope . " h2", $scope . " h3" );
    }

    public static function article_drop_cap_rules( string $scope, string $paragraph ): string {
        return $paragraph . "{overflow:visible}" . $paragraph . "::first-letter{float:left;font-family:Arial,Helvetica,sans-serif;font-size:var(--smpi-dropcap-size,96px);font-weight:900;line-height:.78;color:var(--smpi-dropcap-color,#111111);margin:.08em 24px 0 0;text-transform:uppercase;letter-spacing:0}";
    }
    ...
    public static function article_drop_cap_css(): string {
        ...
        $scope = "body.single-post :where(.entry-content,.post-content,.single-post-content,.wp-block-post-content,.elementor-widget-theme-post-content .elementor-widget-container,.elementor-widget-post-content .elementor-widget-container)";
        return self::article_drop_cap_rules( $scope, $scope . " > p:first-of-type" );
    }
    ...
    public static function preview_bundle_css(): string {
        ...
        $css .= ".smpi-choice-preview .smpi-dropcap-preview{background:#fff;border:1px solid #e2e8f0;border-radius:12px;box-sizing:border-box;max-width:760px;overflow:hidden;padding:28px}.smpi-choice-preview .smpi-dropcap-preview p{color:#333;font-family:Arial,Helvetica,sans-serif;font-size:30px;line-height:1.95;margin:0}";
        $css .= self::article_drop_cap_rules( ".smpi-choice-preview .smpi-dropcap-preview", ".smpi-choice-preview .smpi-dropcap-preview p:first-of-type" );
