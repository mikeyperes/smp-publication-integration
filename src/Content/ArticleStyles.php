...
final class ArticleStyles {
    ...
    public static function inline_photo_css( string $style ): string {
        ...
        if ( "fig2" === $style ) {
            return $scope . "{margin:2.5rem auto;border-radius:16px;overflow:hidden;box-shadow:0 24px 50px -30px rgba(15,15,15,.45)}.elementor-widget-theme-post-content figure img,.entry-content figure img,.wp-caption img{width:100%;display:block}.elementor-widget-theme-post-content figure figcaption,.entry-content figure figcaption,.wp-caption .wp-caption-text{background:#fafafa;border-top:3px solid #d63428;padding:16px 20px;font-family:Georgia,serif;font-style:italic;font-size:16.5px;color:#272727}";
        }
        if ( "fig4" === $style ) {
