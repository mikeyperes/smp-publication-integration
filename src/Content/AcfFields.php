        ...
        acf_add_local_field_group(
            [
                ...
                'fields' => [
                    ...
                    [ "key" => "field_smpi_founder_users", "label" => "Founder Authors", "name" => "smpi_founder_users", "type" => "user", "instructions" => "Bind one or more WordPress author.php users as publication founders.", "role" => "", "return_format" => "id", "multiple" => 1, "allow_null" => 1 ],
