    ...
    private function register_publication_profile_fields(): void {
        acf_add_local_field_group(
            [
                ...
                'fields' => [
                    [ 'key' => 'field_smpi_publication_user', 'label' => 'Publication User', 'name' => 'smpi_publication_user', 'type' => 'user', 'instructions' => 'Bind this publication profile to the WordPress user responsible for managing it.', 'return_format' => 'id', 'multiple' => 0 ],
                    ...
                    [ 'key' => 'field_smpi_schema_markup', 'label' => 'Publication Schema Markup', 'name' => 'smpi_schema_markup', 'type' => 'textarea', 'instructions' => 'Generated JSON-LD for this publication profile. Refresh from the Schema tab.', 'rows' => 10, 'readonly' => 1 ],
                ],
                'location' => [ [ [ 'param' => 'post_type', 'operator' => '==', 'value' => PublicationPostType::POST_TYPE ] ] ],
                'position' => 'normal',
                'style' => 'default',
            ]
        );
    ...
    private function register_user_binding_fields(): void {
        acf_add_local_field_group(
            [
                ...
                'fields' => [
                    [ 'key' => 'field_smpi_primary_publication', 'label' => 'Primary Publication', 'name' => 'smpi_primary_publication', 'type' => 'post_object', 'instructions' => 'Primary publication profile bound to this user.', 'post_type' => [ PublicationPostType::POST_TYPE ], 'return_format' => 'id', 'ui' => 1 ],
                    [ 'key' => 'field_smpi_managed_publications', 'label' => 'Managed Publications', 'name' => 'smpi_managed_publications', 'type' => 'relationship', 'instructions' => 'Additional publication profiles this user can manage.', 'post_type' => [ PublicationPostType::POST_TYPE ], 'filters' => [ 'search' ], 'return_format' => 'id' ],
                ],
