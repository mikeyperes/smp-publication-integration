...
final class PluginRegistry {
    public static function catalog(): array {
        return [
            'hws-base-tools/initialization.php' => [ 'label' => 'HWS Base Tools', 'type' => 'required', 'repo' => 'mikeyperes/hws-base-tools', 'starter' => 'initialization.php' ],
            'advanced-custom-fields-pro/acf.php' => [ 'label' => 'Advanced Custom Fields Pro', 'type' => 'required', 'repo' => '', 'starter' => 'acf.php' ],
            ...
            'hexa-pr-wire-distributor/initialization.php' => [ 'label' => 'Hexa PR Wire Distributor', 'type' => 'recommended', 'repo' => 'mikeyperes/hexa-pr-wire-distributor', 'starter' => 'initialization.php' ],
