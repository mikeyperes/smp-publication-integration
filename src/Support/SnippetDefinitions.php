    ...
    public static function all(): array {
        return [
            ...
            [
                ...
                "default_enabled" => true,
                "description" => "Hides empty author social anchors on single posts and author archives (missing, blank, hash, or javascript hrefs); fully empty Elementor social wrappers are collapsed.",
                ...
                "readme" => "Author social icons\n\nHides empty author social anchors on single posts and author archives.\n\nSetting: smpi_settings[author_social_cleanup].",
            ],
        ];
    }
}
