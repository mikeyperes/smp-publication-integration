...
$checks = [
    'Keeps every plugin version surface on 2.0.9.' => str_contains( $main, 'Version: 2.0.9' )
        && str_contains( $main, 'public const VERSION = "2.0.9";' )
        && str_contains( $legacy, 'Version: 2.0.9' )
        && str_contains( $readme, '- Version: `2.0.9`' ),
