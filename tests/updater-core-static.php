...
$checks = [
    'Keeps every plugin version surface on 1.0.21.' => str_contains( $main, 'Version: 1.0.21' )
        && str_contains( $main, 'public const VERSION = "1.0.21";' )
        && str_contains( $legacy, 'Version: 1.0.21' )
        && str_contains( $readme, '- Version: `1.0.21`' ),
